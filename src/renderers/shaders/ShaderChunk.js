...
import detail_normalmap_fragment from './ShaderChunk/detail_normalmap_fragment.glsl.js';
import detail_normalmap_ao_fragment from './ShaderChunk/detail_normalmap_ao_fragment.glsl.js';
import detail_normalmap_pars_fragment from './ShaderChunk/detail_normalmap_pars_fragment.glsl.js';
...
export const ShaderChunk = {
	...
	bumpmap_pars_fragment: USE_EXTRA_MAP_SLOTS ? bumpmap_pars_fragment : '',
	...
	displacementmap_pars_vertex: USE_EXTRA_MAP_SLOTS ? displacementmap_pars_vertex : '',
	displacementmap_vertex: USE_EXTRA_MAP_SLOTS ? displacementmap_vertex : '',
	...
	detail_normalmap_fragment: detail_normalmap_fragment,
	detail_normalmap_ao_fragment: detail_normalmap_ao_fragment,
	detail_normalmap_pars_fragment: detail_normalmap_pars_fragment,
	morphinstance_vertex: USE_MORPH_TARGETS ? morphinstance_vertex : '',
	morphcolor_vertex: USE_MORPH_TARGETS ? morphcolor_vertex : '',
	morphnormal_vertex: USE_MORPH_TARGETS ? morphnormal_vertex : '',
	morphtarget_pars_vertex: USE_MORPH_TARGETS ? morphtarget_pars_vertex : '',
	morphtarget_vertex: USE_MORPH_TARGETS ? morphtarget_vertex : '',
	...
	specularmap_pars_fragment: USE_EXTRA_MAP_SLOTS ? specularmap_pars_fragment : '',
	...
	...( USE_EXOTIC_MATERIALS ? { linedashed_vert: linedashed.vertex, linedashed_frag: linedashed.fragment } : {} ),
	...
	...( USE_EXOTIC_MATERIALS ? { meshmatcap_vert: meshmatcap.vertex, meshmatcap_frag: meshmatcap.fragment } : {} ),
	...( USE_EXOTIC_MATERIALS ? { meshnormal_vert: meshnormal.vertex, meshnormal_frag: meshnormal.fragment } : {} ),
	...
	...( USE_EXOTIC_MATERIALS ? { meshtoon_vert: meshtoon.vertex, meshtoon_frag: meshtoon.fragment } : {} ),
	...( USE_EXOTIC_MATERIALS ? { points_vert: points.vertex, points_frag: points.fragment } : {} ),
	...( USE_EXOTIC_MATERIALS ? { shadow_vert: shadow.vertex, shadow_frag: shadow.fragment } : {} ),
	...( USE_EXOTIC_MATERIALS ? { sprite_vert: sprite.vertex, sprite_frag: sprite.fragment } : {} )
};
